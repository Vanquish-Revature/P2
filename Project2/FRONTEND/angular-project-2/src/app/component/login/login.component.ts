...
import { FormsModule, Form, ReactiveFormsModule, FormBuilder } from '@angular/forms';
...
export class LoginComponent implements OnInit {
  ...
  Loginuser()
  {
    ...
    let response = this._http.post<any>("http://localhost:7100/rainforest/user/login",user,httpOptions).subscribe(
      {
